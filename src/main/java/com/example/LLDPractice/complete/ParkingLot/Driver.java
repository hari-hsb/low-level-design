package com.example.LLDPractice.complete.ParkingLot;

import com.example.LLDPractice.complete.ParkingLot.commands.CommandFactory;
...
//            System.out.println("###############"+commands[i]+"##################");
            CommandFactory.getCommand(commands[i]).execute();
        }
    }
}
